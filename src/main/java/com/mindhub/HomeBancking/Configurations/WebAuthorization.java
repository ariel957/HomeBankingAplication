...
class WebAuthorization extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/web/index.html","/web/scripts/index.js","/web/styles/styles.css").permitAll()
                ...
                .antMatchers("/web/**","/web/img/**","/web/styles/**","/web/scripts/**").hasAnyAuthority("CLIENT","ADMIN");
